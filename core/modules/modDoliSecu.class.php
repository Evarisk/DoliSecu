...
/**
 * \defgrou dolisecu Module DoliSecu
 * \brief   DoliSecu module descriptor
 *
 * \file    core/modules/modDoliSecu.class.php
 * \ingroup dolisecu
...
class modDoliSecu extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->description = $langs->transnoentities('DoliSecuDescription');
        // Used only if file README.md and README-LL.md not found
        $this->descriptionlong = $langs->transnoentities('DoliSecuDescriptionLong');
        ...
        // Config pages. Put here list of php page, stored into dolisecu/admin directory, to use to set up module
        ...
        $this->const = [
            // CONST MODULE
            $i++ => ['DOLISECU_VERSION', 'chaine', $this->version, '', 0, 'current'],
            $i++ => ['DOLISECU_DB_VERSION', 'chaine', $this->version, '', 0, 'current'],
            $i   => ['DOLISECU_SHOW_PATCH_NOTE', 'integer', 1, '', 0, 'current'],
        ];
        ...
        $this->rights[$r][0] = $this->numero . sprintf('%02d', $r + 1);
        $this->rights[$r][1] = $langs->trans('ReadAdminPageDoliSecu');
        ...
        $this->menu[$r++] = [
            ...
            'perms'    => '$user->rights->dolisecu->read',               // Use 'perms'=>'$user->rights->dolisecu->myobject->read' if you want your menu with a permission rules
            'target'   => '',
    ...
    public function init($options = ''): int
    {
        ...
        dolibarr_set_const($this->db, 'DOLISECU_VERSION', $this->version, 'chaine', 0, '', $conf->entity);
        dolibarr_set_const($this->db, 'DOLISECU_DB_VERSION', $this->version, 'chaine', 0, '', $conf->entity);
