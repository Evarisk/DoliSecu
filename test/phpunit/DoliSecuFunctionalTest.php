...
/**
 * \file    test/phpunit/DoliSecuFunctionalTest.php
 * \ingroup dolisecu
 ...
 *
 * @package Testdolisecu
 */
class DoliSecuFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolisecu/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolisecu/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolisecu/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolisecu/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolisecuwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliSecu_DoliSecuTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliSecu_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
